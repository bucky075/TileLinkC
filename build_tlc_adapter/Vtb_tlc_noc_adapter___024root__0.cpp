...
void Vtb_tlc_noc_adapter___024root___eval_triggers_vec__act(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_triggers_vec__act\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
bool Vtb_tlc_noc_adapter___024root___trigger_anySet__act(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___trigger_anySet__act\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
void Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__0(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__0\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__1(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__1\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*2:0*/ __Vdly__tb_tlc_noc_adapter__DOT__state;
    ...
    if (vlSelfRef.rst_n) {
        if ((1U == (IData)(vlSelfRef.tb_tlc_noc_adapter__DOT__state))) {
            ...
            vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[2U] 
                = (0x000001feU | ((1U & vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[2U]) 
                                  | ((IData)(vlSelfRef.tb_tlc_noc_adapter__DOT__addr) 
                                     << 9U)));
            vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[3U] 
                = ((1U & ((IData)(vlSelfRef.tb_tlc_noc_adapter__DOT__addr) 
                          >> 0x00000017U)) | ((0x000001feU 
                                               & ((IData)(vlSelfRef.tb_tlc_noc_adapter__DOT__addr) 
                                                  >> 0x00000017U)) 
                                              | ((IData)(
                                                         (vlSelfRef.tb_tlc_noc_adapter__DOT__addr 
                                                          >> 0x00000020U)) 
                                                 << 9U)));
            vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[4U] 
                = ((0x03f00000U & vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[4U]) 
                                     ...
                                     ((1U & ((IData)(
                                      ...
                                      | (0x000001feU 
                                         & ((IData)(
                                            ...
                                            >> 0x00000017U))))));
            vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[0U] 
                = (IData)(vlSelfRef.tb_tlc_noc_adapter__DOT__write_data);
            vlSelfRef.tb_tlc_noc_adapter__DOT__a_bits[1U] 
                = (IData)((vlSelfRef.tb_tlc_noc_adapter__DOT__write_data 
                           >> 0x00000020U));
            ...
            VL_FINISH_MT("tb/tb_tlc_noc_adapter.sv", 241, "");
        }
    } else {
...
extern const VlWide<8>/*255:0*/ Vtb_tlc_noc_adapter__ConstPool__CONST_h9e67c271_0;
extern const VlWide<8>/*255:0*/ Vtb_tlc_noc_adapter__ConstPool__CONST_h1e479923_0;

void Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__2(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__2\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    if (vlSelfRef.rst_n) {
        if (vlSelfRef.tb_tlc_noc_adapter__DOT__manager_i__DOT__out_valid_reg) {
            ...
            VL_ASSIGN_W(256, vlSelfRef.tb_tlc_noc_adapter__DOT__manager_i__DOT__out_flit_reg, Vtb_tlc_noc_adapter__ConstPool__CONST_h9e67c271_0);
        }
        ...
        if (vlSelfRef.tb_tlc_noc_adapter__DOT__manager_i__DOT__processing_req) {
            ...
            VL_ASSIGN_W(230, vlSelfRef.tb_tlc_noc_adapter__DOT__manager_i__DOT__out_payload, Vtb_tlc_noc_adapter__ConstPool__CONST_h1e479923_0);
    ...
    if (vlSelfRef.rst_n) {
        ...
        if ((0U == (IData)(vlSelfRef.tb_tlc_noc_adapter__DOT__client_i__DOT__send_state))) {
            ...
            VL_ASSIGN_W(230, vlSelfRef.tb_tlc_noc_adapter__DOT__client_i__DOT__req_payload, Vtb_tlc_noc_adapter__ConstPool__CONST_h1e479923_0);
        ...
        vlSelfRef.__Vdly__tb_tlc_noc_adapter__DOT__client_i__DOT__req_beat_idx = 0U;
        vlSelfRef.tb_tlc_noc_adapter__DOT__client_i__DOT__noc_req_valid_r = 0U;
        VL_ASSIGN_W(256, vlSelfRef.tb_tlc_noc_adapter__DOT__client_i__DOT__noc_req_flit_r, Vtb_tlc_noc_adapter__ConstPool__CONST_h9e67c271_0);
    }
    vlSelfRef.tb_tlc_noc_adapter__DOT__client_i__DOT__req_buf[0U] 
        = vlSelfRef.__Vdly__tb_tlc_noc_adapter__DOT__client_i__DOT__req_buf[0U];
    vlSelfRef.tb_tlc_noc_adapter__DOT__client_i__DOT__req_buf[1U] 
...
void Vtb_tlc_noc_adapter___024root___eval_nba(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_nba\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
        Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__1(vlSelf);
    }
    if ((3ULL & vlSelfRef.__VnbaTriggered[0U])) {
        Vtb_tlc_noc_adapter___024root___nba_sequent__TOP__2(vlSelf);
    }
}

void Vtb_tlc_noc_adapter___024root___trigger_orInto__act_vec_vec(VlUnpacked<QData/*63:0*/, 1> &out, const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___trigger_orInto__act_vec_vec\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG

bool Vtb_tlc_noc_adapter___024root___eval_phase__act(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_phase__act\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtb_tlc_noc_adapter___024root___eval_triggers_vec__act(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vtb_tlc_noc_adapter___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
    }
#endif
    Vtb_tlc_noc_adapter___024root___trigger_orInto__act_vec_vec(vlSelfRef.__VnbaTriggered, vlSelfRef.__VactTriggered);
    return (0U);
}

void Vtb_tlc_noc_adapter___024root___trigger_clear__act(VlUnpacked<QData/*63:0*/, 1> &out) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___trigger_clear__act\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
bool Vtb_tlc_noc_adapter___024root___eval_phase__nba(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_phase__nba\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __VnbaExecute;
    // Body
    __VnbaExecute = Vtb_tlc_noc_adapter___024root___trigger_anySet__act(vlSelfRef.__VnbaTriggered);
    if (__VnbaExecute) {
        Vtb_tlc_noc_adapter___024root___eval_nba(vlSelf);
        Vtb_tlc_noc_adapter___024root___trigger_clear__act(vlSelfRef.__VnbaTriggered);
    }
    return (__VnbaExecute);
}

void Vtb_tlc_noc_adapter___024root___eval(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    do {
...
#ifdef VL_DEBUG
            Vtb_tlc_noc_adapter___024root___dump_triggers__act(vlSelfRef.__VnbaTriggered, "nba"s);
#endif
        ...
        do {
            ...
            vlSelfRef.__VactPhaseResult = Vtb_tlc_noc_adapter___024root___eval_phase__act(vlSelf);
        } while (vlSelfRef.__VactPhaseResult);
        vlSelfRef.__VnbaPhaseResult = Vtb_tlc_noc_adapter___024root___eval_phase__nba(vlSelf);
    } while (vlSelfRef.__VnbaPhaseResult);
}

#ifdef VL_DEBUG
void Vtb_tlc_noc_adapter___024root___eval_debug_assertions(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_debug_assertions\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

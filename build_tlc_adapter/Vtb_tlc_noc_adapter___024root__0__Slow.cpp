...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_static(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_static__TOP(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_static__TOP\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const uint64_t __VscopeHash = VL_MURMUR64_HASH(vlSelf->vlNamep);
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_initial(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_initial\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelfRef.tb_tlc_noc_adapter__DOT__addr = 0x0000000000000040ULL;
    vlSelfRef.tb_tlc_noc_adapter__DOT__write_data = 0xdeadbeefcafebabeULL;
}

VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_initial__TOP(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_initial__TOP\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.tb_tlc_noc_adapter__DOT__a_valid = 0U;
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_final(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_final\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vtb_tlc_noc_adapter___024root___eval_phase__stl(Vtb_tlc_noc_adapter___024root* vlSelf);

VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_settle(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_settle\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    do {
...
#ifdef VL_DEBUG
            Vtb_tlc_noc_adapter___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
        ...
        vlSelfRef.__VstlPhaseResult = Vtb_tlc_noc_adapter___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_triggers_vec__stl(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_triggers_vec__stl\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vtb_tlc_noc_adapter___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vtb_tlc_noc_adapter___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vtb_tlc_noc_adapter___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___stl_sequent__TOP__0(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___stl_sequent__TOP__0\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___eval_stl(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_stl\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vtb_tlc_noc_adapter___024root___eval_phase__stl(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___eval_phase__stl\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __VstlExecute;
    // Body
    Vtb_tlc_noc_adapter___024root___eval_triggers_vec__stl(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vtb_tlc_noc_adapter___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
    }
#endif
    __VstlExecute = Vtb_tlc_noc_adapter___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
        Vtb_tlc_noc_adapter___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___dump_triggers__act\n"); );
    // Body
    if ((1U & (~ (IData)(Vtb_tlc_noc_adapter___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vtb_tlc_noc_adapter___024root___ctor_var_reset(Vtb_tlc_noc_adapter___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_tlc_noc_adapter___024root___ctor_var_reset\n"); );
    Vtb_tlc_noc_adapter__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    const uint64_t __VscopeHash = VL_MURMUR64_HASH(vlSelf->vlNamep);
    ...
    vlSelf->tb_tlc_noc_adapter__DOT__state = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 6724115963080757973ull);
    vlSelf->tb_tlc_noc_adapter__DOT__addr = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 3415620479518366307ull);
    vlSelf->tb_tlc_noc_adapter__DOT__write_data = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 10622501544510412671ull);

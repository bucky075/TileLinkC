...
#ifndef VERILATED_VTB_TLC_NOC_ADAPTER___024ROOT_H_
#define VERILATED_VTB_TLC_NOC_ADAPTER___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtb_tlc_noc_adapter___024root final {
  public:
    ...
    struct {
        ...
        CData/*2:0*/ tb_tlc_noc_adapter__DOT__state;
        ...
        QData/*63:0*/ tb_tlc_noc_adapter__DOT__write_data;
    ...
    // INTERNAL VARIABLES
    Vtb_tlc_noc_adapter__Syms* vlSymsp;
    const char* vlNamep;

    // CONSTRUCTORS
    Vtb_tlc_noc_adapter___024root(Vtb_tlc_noc_adapter__Syms* symsp, const char* namep);
    ~Vtb_tlc_noc_adapter___024root();
    VL_UNCOPYABLE(Vtb_tlc_noc_adapter___024root);

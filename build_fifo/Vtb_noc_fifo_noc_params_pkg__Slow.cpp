...
VL_CTOR_IMP(Vtb_noc_fifo_noc_params_pkg) {
    // Reset internal values
    // Reset structure values
    _ctor_var_reset();
}

void Vtb_noc_fifo_noc_params_pkg::__Vconfigure(Vtb_noc_fifo__Syms* vlSymsp, bool first) {
    if (false && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
    if (false && this->__VlSymsp) {}  // Prevent unused
}

Vtb_noc_fifo_noc_params_pkg::~Vtb_noc_fifo_noc_params_pkg() {
}

void Vtb_noc_fifo_noc_params_pkg::_initial__TOP__noc_params_pkg__1(Vtb_noc_fifo__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_noc_fifo_noc_params_pkg::_initial__TOP__noc_params_pkg__1\n"); );
...
void Vtb_noc_fifo_noc_params_pkg::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_noc_fifo_noc_params_pkg::_ctor_var_reset\n"); );
    // Body
}

...
VL_INLINE_OPT void Vtlc_mesh_adapter::_combo__TOP__10(Vtlc_mesh_adapter__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtlc_mesh_adapter::_combo__TOP__10\n"); );
...
void Vtlc_mesh_adapter::_eval(Vtlc_mesh_adapter__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtlc_mesh_adapter::_eval\n"); );
    Vtlc_mesh_adapter* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT QData Vtlc_mesh_adapter::_change_request(Vtlc_mesh_adapter__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtlc_mesh_adapter::_change_request\n"); );
    Vtlc_mesh_adapter* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    return (vlTOPp->_change_request_1(vlSymsp));
}

VL_INLINE_OPT QData Vtlc_mesh_adapter::_change_request_1(Vtlc_mesh_adapter__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtlc_mesh_adapter::_change_request_1\n"); );
    Vtlc_mesh_adapter* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
...
#ifdef VL_DEBUG
void Vtlc_mesh_adapter::_eval_debug_assertions() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtlc_mesh_adapter::_eval_debug_assertions\n"); );
    // Body
